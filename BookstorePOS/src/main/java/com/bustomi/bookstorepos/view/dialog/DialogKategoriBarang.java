 ...
 * @author PacuL
 */
public class DialogKategoriBarang extends javax.swing.JDialog {

    private KategoriBarang data;
    private boolean editMode;
    private boolean deleteMode;
    private boolean okhapus;
    
    public DialogKategoriBarang() {
        setModal(true);
        initComponents();        
    ...
    public KategoriBarang tambah() {
        
        
        editMode = false;
        deleteMode = false;
        
        jLabelInfo.setText("Tambah KategoriBarang Baru");
        setTitle("Tambah KategoriBarang Baru");
        textFieldXId.setEnabled(false);
        setVisible(true);
        return data;
    }
    
    public KategoriBarang ubah(KategoriBarang parameter){
        
        editMode = true;
        
        
        jLabelInfo.setText("Edit KategoriBarang");
        setTitle("Edit KategoriBarang");
    ...
    public void detail(KategoriBarang parameter) {
                
        jLabelInfo.setText("Detail KategoriBarang");
        setTitle("Detail KategoriBarang");
    ...
    public boolean delete(KategoriBarang parameter) {
        
        deleteMode=true;
                
        jLabelInfo.setText("Yakin Hapus?");
        setTitle("Hapus KategoriBarang");
    ...
    private void buttonGreen1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGreen1ActionPerformed
        ...
        if (deleteMode) {
            ...
            KategoriBarangValidator validator=SpringManager.getInstance().getBean(KategoriBarangValidator.class);
            try {
