...
import com.bustomi.bookstorepos.view.tablemodel.TabelModelSatuan;
 ...
 * @author PacuL
 */
public class PanelSatuan extends javax.swing.JPanel {

    private final TabelModelSatuan modelSatuan;
...
//        loadData();
    ...
    private void initComponents() {
        ...
        buttonYellow1.setText("Perbarui Satuan");
        ...
        buttonRed1.setText("Hapus Satuan");
    ...
    private void buttonRed1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRed1ActionPerformed
        if (TabelSatuan.getSelectedColumn() == -1) {
            JOptionPane.showMessageDialog(this, "Silahkan pilih data satuan!");
        }else {
            int pilih=TabelSatuan.convertRowIndexToModel(TabelSatuan.getSelectedRow());
            Satuan satuan=modelSatuan.ambilData(pilih);
            
            DialogSatuan dialogSatuan=new DialogSatuan();
            dialogSatuan.setLocationRelativeTo(this);
            boolean hasil=dialogSatuan.delete(satuan);
            ...
            if (hasil) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Data Satuan tidak bisa dihapus!");
                    Logger.getLogger(PanelSatuan.class.getName()).log(Level.SEVERE, null, e);
                }
            }
    ...
    private void buttonYellow1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonYellow1ActionPerformed
        if (TabelSatuan.getSelectedColumn() == -1) {
            ...
            DialogSatuan dialogSatuan=new DialogSatuan();
            dialogSatuan.setLocationRelativeTo(this);
            Satuan hasil=dialogSatuan.ubah(satuan);
            if (hasil != null) {
                SatuanService satuanService=SpringManager.getInstance().getBean(SatuanService.class);
                satuanService.update(hasil);           
            }
            loadData();
    ...
    private void buttonGreen1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGreen1ActionPerformed
        ...
        Satuan satuan=dialogSatuan.tambah();
        if (satuan != null) {
    ...
    private void cari(){
        ...
        SatuanService service=SpringManager.getInstance().getBean(SatuanService.class);
        List<Satuan> satuans=service.findAll(nama);
        if (satuans != null) {
            modelSatuan.load(satuans);
