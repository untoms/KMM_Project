...
public class PanelUser extends javax.swing.JPanel {
    ...
    private final TabelModelUser modelUser;
    ...
    public PanelUser()  {
        ...
        TabelUser.getColumnModel().getColumn(3).setCellRenderer(new HurufRender());  
        TabelUser.getColumnModel().getColumn(4).setCellRenderer(new HurufRender());         
        TabelUser.getColumnModel().getColumn(5).setCellRenderer(new HurufRender()); 
        TabelUser.getColumnModel().getColumn(6).setCellRenderer(new HurufRender());  
        TabelUser.getColumnModel().getColumn(7).setCellRenderer(new HurufRender());         
        TabelUser.getColumnModel().getColumn(8).setCellRenderer(new HurufRender());  
        TabelUser.getColumnModel().getColumn(9).setCellRenderer(new HurufRender()); 
        TabelUser.getColumnModel().getColumn(10).setCellRenderer(new HurufRender());  
    ...
    private void initComponents() {
        ...
        buttonGreen1.setText("Tambah User");
        ...
        buttonYellow1.setText("Perbarui User");
    ...
    private void buttonBlue1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonBlue1ActionPerformed
        if (TabelUser.getSelectedColumn() == -1) {
            ...
            int pilih=TabelUser.convertRowIndexToModel(TabelUser.getSelectedRow());
            User user=modelUser.ambilData(pilih);
            dialogUser.detail(user);
    ...
    private void buttonRed1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRed1ActionPerformed
        if (TabelUser.getSelectedColumn() == -1) {
            ...
            DialogUser dialogUser=new DialogUser();
            dialogUser.setLocationRelativeTo(this);
            boolean hasil=dialogUser.delete(user);
    ...
    private void buttonYellow1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonYellow1ActionPerformed
        if (TabelUser.getSelectedColumn() == -1) {
            ...
            DialogUser dialogUser=new DialogUser();
            dialogUser.setLocationRelativeTo(this);
            User hasil=dialogUser.ubah(user);
            if (hasil != null) {
                UserService userService=SpringManager.getInstance().getBean(UserService.class);
