...
public class DialogPemasukan extends javax.swing.JDialog {
    ...
    public Pemasukan tambah() {
        
        
        editMode = false;
        deleteMode = false;
        
        jLabelInfo.setText("Tambah Pemasukan Baru");
        setTitle("Tambah Pemasukan Baru");
        textFieldXId.setEnabled(false);
        setVisible(true);
        return data;
    }
    
    public Pemasukan ubah(Pemasukan parameter){
        
        editMode = true;
        
        
        jLabelInfo.setText("Edit Pemasukan");
    ...
    public void detail(Pemasukan parameter) {
                
        jLabelInfo.setText("Detail Pemasukan");
    ...
    public boolean delete(Pemasukan parameter) {
    ...
    private void buttonGreen1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGreen1ActionPerformed
        ...
        if (deleteMode) {
            ...
            if (nama.trim().equals("")) {
                ...
                JOptionPane.showMessageDialog(this, "Jumlah pemasukan tidak valid");
