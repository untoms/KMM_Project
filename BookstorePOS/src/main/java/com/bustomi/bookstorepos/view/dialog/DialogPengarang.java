 ...
 * @author PacuL
 */
public class DialogPengarang extends javax.swing.JDialog {

    private Pengarang data;
    private boolean editMode;
    private boolean deleteMode;
    private boolean okhapus;
    
    public DialogPengarang() {
        setModal(true);
        initComponents();        
    ...
    public Pengarang tambah() {
        
        
        editMode = false;
        deleteMode = false;
        
        jLabelInfo.setText("Tambah Pengarang Baru");
        setTitle("Tambah Pengarang Baru");
        textFieldXId.setEnabled(false);
        setVisible(true);
        return data;
    }
    
    public Pengarang ubah(Pengarang parameter){
        
        editMode = true;
        
        
        jLabelInfo.setText("Edit Pengarang");
        setTitle("Edit Pengarang");
    ...
    public void detail(Pengarang parameter) {
                
        jLabelInfo.setText("Detail Pengarang");
        setTitle("Detail Pengarang");
    ...
    public boolean delete(Pengarang parameter) {
        
        deleteMode=true;
                
        jLabelInfo.setText("Yakin Hapus?");
        setTitle("Hapus Pengarang");
