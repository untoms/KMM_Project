 ...
 * @author PacuL
 */
public class PanelKatalogBuku extends javax.swing.JPanel {

    private final TabelModelBuku modelBuku;
    
    public PanelKatalogBuku()  {
...
//        loadData();
    ...
    private void buttonMin2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMin2ActionPerformed
        ...
        if (!jRadioJudul.isSelected() && !jRadioPenerbit.isSelected() && !jRadioPengarang.isSelected()) {
    ...
    private void loadData() {
        ...
        modelBuku.load(barangService.findAll());
    }
