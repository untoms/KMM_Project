...
import com.bustomi.bookstorepos.validator.implement.SatuanValidator;
...
public class DialogSatuan extends javax.swing.JDialog {
    ...
    public Satuan tambah() {
        
        
        editMode = false;
        deleteMode = false;
        
        jLabelInfo.setText("Tambah Satuan Baru");
        setTitle("Tambah Satuan Baru");
        textFieldXId.setEnabled(false);
        setVisible(true);
        return data;
    }
    
    public Satuan ubah(Satuan parameter){
        
        editMode = true;
        
        
        jLabelInfo.setText("Edit Satuan");
    ...
    public void detail(Satuan parameter) {
                
        jLabelInfo.setText("Detail Satuan");
        setTitle("Detail Satuan");
    ...
    public boolean delete(Satuan parameter) {
    ...
    private void initComponents() {
        ...
        panelX1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Data Satuan Barang", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
